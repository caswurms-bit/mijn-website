...
const DESKTOP_FRAME_COUNT = 104;
const DESKTOP_START_FRAME = 45;
const DESKTOP_BASE_URL =
  'https://lnzbfjukwcfzojuiqxgm.supabase.co/storage/v1/object/public/video%20website';
...
function getDesktopFrameSrc(index: number) {
  ...
  return `${DESKTOP_BASE_URL}/frame_${padded}_delay-0.042s.webp`;
}
