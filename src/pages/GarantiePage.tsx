        ...
        <div className="space-y-10 sm:space-y-12">
          <section>
            ...
            <div className="space-y-3 text-sm sm:text-base text-slate-600 leading-relaxed">
              ...
              <p>2 jaar garantie op de complete pc. Je mag verwachten dat jouw computer gedurende deze periode functioneert zoals je als consument redelijkerwijs mag verwachten.</p>
